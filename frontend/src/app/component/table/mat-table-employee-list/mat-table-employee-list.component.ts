...
@Component({
  selector: 'app-mat-table-employee-list',
  standalone: true,
  imports: [MatTableModule,
    ...
    FormsModule,
    MatSortModule],
  templateUrl: './mat-table-employee-list.component.html',
  styleUrl: './mat-table-employee-list.component.scss'
})
export class MatTableEmployeeListComponent {
